...
/* harmony import */ var _js_modules_swiper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../js/modules/swiper.js */ "./js/modules/swiper.js");
/* harmony import */ var _js_modules_video_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../js/modules/video.js */ "./js/modules/video.js");
/* harmony import */ var _js_modules_tabs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../js/modules/tabs.js */ "./js/modules/tabs.js");
/* harmony import */ var _js_modules_validation_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../js/modules/validation.js */ "./js/modules/validation.js");
/* harmony import */ var _js_modules_coaches_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../js/modules/coaches.js */ "./js/modules/coaches.js");
...
/* harmony import */ var _modules_utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/utils.js */ "./js/modules/utils.js");

var successForm = document.querySelector('.success');
var successCloseButton = document.querySelector('.success__button');
var errorForm = document.querySelector('.error');
var errorCloseButton = document.querySelector('.error__button');

var onShowResultEscKeydown = function onShowResultEscKeydown(evt) {
  if (Object(_modules_utils_js__WEBPACK_IMPORTED_MODULE_0__["isEscapeKey"])(evt)) {
    evt.preventDefault();
...
var coachesSwiperSlide = coachesSwiper.querySelectorAll('.swiper-slide');

var addTabindexSwiperSlide = function addTabindexSwiperSlide() {
  coachesSwiperSlide.forEach(function (slide) {
...
coachesSwiperSlide.forEach(function (slide) {
  ...
  slide.addEventListener('keydown', function (evt) {
    if (Object(_modules_utils_js__WEBPACK_IMPORTED_MODULE_0__["isTabKey"])(evt)) {
      addTabindexSwiperSlide();
    }
  });
});
...
/*!******************************!*\
  !*** ./js/modules/swiper.js ***!
  \******************************/
/*! exports provided: coachesSwiper, reviewsSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "coachesSwiper", function() { return coachesSwiper; });
...
var coachesSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.coaches__swiper', {
...
var reviewsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__swiper', {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"]],
  loop: false,
  slidesPerView: 1,
  spaceBetween: 100,
...
var tabs = document.querySelectorAll('.subscriptions__tabs-item');
var tabContent = document.querySelectorAll('.subscriptions__tabs-content-list');

var hideTab = function hideTab() {
...
tabs.forEach(function (tab, i) {
  ...
  tab.addEventListener('keydown', function (evt) {
    if (Object(_modules_utils_js__WEBPACK_IMPORTED_MODULE_0__["isEnterKey"])(evt)) {
      evt.preventDefault();
      hideTab();
      tab.classList.add('subscriptions__tabs-item--current');
      tabContent[i].classList.add('subscriptions__tabs-content-list--current');
...
/*!*****************************!*\
  !*** ./js/modules/utils.js ***!
  \*****************************/
/*! exports provided: isEscapeKey, isEnterKey, isTabKey */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var nameInput = document.querySelector('input[name=contactsName]');
var telInput = document.querySelector('input[name=contactsPhone]');
nameInput.addEventListener('input', function () {
  var value = nameInput.value;
  var nameRegExp = /^[a-zA-Zа-яА-Я]+/g;
...
telInput.addEventListener('input', function () {
  ...
  var telRegExp = /^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$/g;
...
form.addEventListener('submit', function (evt) {
  evt.preventDefault();
  Object(_api__WEBPACK_IMPORTED_MODULE_0__["sendData"])();
  evt.target.reset();
});
...
var gymVideoPlayer = document.querySelector('#player');
...
function loadVideo() {
  ...
  var playerButtonContainer = document.querySelector('.gym__video-button-container');
  var playerButtonPlay = document.querySelector('.gym__video-button');
  playerButtonPlay.addEventListener('click', function () {
    playerButtonContainer.classList.add('gym__video-button-container--hidden');
    player.playVideo();
  });
  playerButtonPlay.addEventListener('keydown', function (evt) {
    if (Object(_modules_utils_js__WEBPACK_IMPORTED_MODULE_0__["isEnterKey"])(evt)) {
      playerButtonContainer.classList.add('gym__video-button-container--hidden');
      player.playVideo();
    }
